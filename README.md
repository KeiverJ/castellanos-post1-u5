...
Aplicación web Java desarrollada con Servlets y JSP para gestionar una lista de tareas en memoria. Implementa el patrón **Post/Redirect/Get (PRG)** para evitar el reenvío de formularios al recargar la página.
...
5. **Acceder a la aplicación**
   ...
   [http://localhost:8080/gestion-tareas/tareas](http://localhost:8080/gestion-tareas/tareas)
